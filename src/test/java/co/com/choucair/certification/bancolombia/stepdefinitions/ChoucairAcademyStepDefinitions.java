package co.com.choucair.certification.bancolombia.stepdefinitions;

import co.com.choucair.certification.bancolombia.models.AcademyChoucairData;
...
import co.com.choucair.certification.bancolombia.tasks.OpenUp;
import co.com.choucair.certification.bancolombia.tasks.Search;
...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanJavierWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorCalled("Javier").wasAbleTo(OpenUp.thePage(), Login.
